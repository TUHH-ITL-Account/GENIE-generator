...
public class SelectCharactersFromMCTest extends FileWritingTest {
  ...
  public void testSelectCharactersFromMC()
    ...
    FdlNode node = c.getFdlnodes().get("Unstetigförderer_Char");
  ...
  @Test
  public void testSelectCharacterFromMCJsonSolution()
      throws Exception {
    Configuration cfg = new Configuration(Configuration.VERSION_2_3_28);
    try {
      cfg.setDirectoryForTemplateLoading(new File("src/main/resources/templates"));
