...
public class InputSomeFigureLabelsTest extends FileWritingTest {

  @Test
  public void testInputSomeFigureLabels()
    ...
    GenerationTask dummyTask = new GenerationTask("TechnischeLogistikSS21", "Fördertechnik",
        "Grundbegriffe_Fördertechnik_Fig");
    dummyTask.setModeldir("./src/test/resources/knowledgemodels/TechnischeLogistikSS21");
    dummyTask.initMissingWithDefaults();
    dummyTask.getParameters().put("difficulty", 6);
    FdlNode node = c.getFdlnodes().get("Grundbegriffe_Fördertechnik_Fig");

    InputSomeFigureLabels exercise = new InputSomeFigureLabels(node, dummyTask);
