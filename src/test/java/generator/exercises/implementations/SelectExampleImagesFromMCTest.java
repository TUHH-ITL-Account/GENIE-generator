...
public class SelectExampleImagesFromMCTest extends FileWritingTest {

  @Test
  public void testSelectExampleImagesFromMC()
    ...
    GenerationTask dummyTask = new GenerationTask("TechnischeLogistikSS21", "Colors",
        "Colors_Ex");
    dummyTask.initMissingWithDefaults();
    dummyTask.getParameters().put("difficulty", 6);
    FdlNode node = c.getFdlnodes().get("Colors_Ex");

    SelectExampleImagesFromMC exercise = new SelectExampleImagesFromMC(node, dummyTask);
