...
public class InputFigureLabelsTest extends FileWritingTest {

  @Test
  public void testInputFigureLabels()
    ...
    InputFigureLabels exercise = new InputFigureLabels(node, dummyTask);
