...
public class SelectSolutionForEquationFromSCTest extends FileWritingTest {

  @Test
  public void testSelectSolutionForEquationFromSC()
      throws Exception {
    ...
    SelectSolutionForEquationFromSC exercise = new SelectSolutionForEquationFromSC(node, dummyTask);
  ...
  @Test
  public void testSelectSolutionForEquationFromSCJsonSolution()
      throws Exception {
    Configuration cfg = new Configuration(Configuration.VERSION_2_3_28);
    try {
      cfg.setDirectoryForTemplateLoading(new File("src/main/resources/templates"));
